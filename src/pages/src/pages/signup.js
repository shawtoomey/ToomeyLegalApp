       ...
       <header className="App-header">
        ...
        <form className="Sign-Up-Form">
          <div className="form-group">
           <label>Title </label>
           <br />
           <select value="Please select option">
         ...
         <div className="form-group">
          ...
          <input type="text" className="forename" {...register("forename")}/>
         </div>
         <div className="form-group">
          <label>Surname </label>
         ...
         <div className="form-group">
          <label>Email </label>
          <input type="email" className="email" {...register("email")}/>
         </div>
         <div className="form-group">
         ...
         <div className="form-group">
          ...
          <input type="passwordconfirm" className="passwordconfirm" {...register("passwordconfirm")}/>
         </div>
         <br />
         <button type="submit" className="sign-up-submittion-btn">Submit</button>
        </form>
       </header>
      </div>
    </div>
